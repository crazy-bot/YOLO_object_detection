...
parser.add_argument("--model_config_path", type=str, default="config/mydata_yolov3.cfg", help="path to model config file")
parser.add_argument("--data_config_path", type=str, default="config/mydata.data", help="path to data config file")
parser.add_argument("--weights_path", type=str, default="checkpoints/440.weights", help="path to weights file/ can use darknet53.conv.74")
...
for epoch in range(441,opt.epochs):
    losses_x = losses_y = losses_w = losses_h = losses_conf = losses_cls = losses_recall = losses_precision = batch_loss= 0.0
